...
namespace Calculator
{
    public partial class ucVolume : UserControl
    {
        ...
        public ucVolume()
        {
            ...
            if (cmbToUnit.Items.Count > 0) cmbToUnit.SelectedIndex = 0;   
            txtFromValue.Text = "0";
            txtToValue.Text = "0";
        ...
        private void PerformConversion()
        {
            ...
            switch (fromUnit)
            {
                case "Milliliters": liters = inputValue / 1000.0; break;
                case "Liters": liters = inputValue; break;
                case "Cubic Meters": liters = inputValue * 1000.0; break;
                case "Gallons": liters = inputValue * 3.78541; break;
                default: return;
            }
            ...
            switch (toUnit)
            {
                case "Milliliters": result = liters * 1000.0; break;
                case "Liters": result = liters; break;
                case "Cubic Meters": result = liters / 1000.0; break;
                case "Gallons": result = liters / 3.78541; break;
                default: return;
            }
        ...
        private void ucVolume_Resize(object sender, EventArgs e)
        {
            UpdateConverterLayout();
        }
